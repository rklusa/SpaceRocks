...
namespace Utility.Drawing
{
    public static class Primitives2D
    {
        ...
        /// <param name="spriteBatch">The destination drawing surface</param>
        /// <param name="location">Where to draw</param>
        /// <param name="vertices">The array of verts to draw connected lines to</param>
        /// <param name="color">The color to draw the polygon in</param>
        /// <param name="thickness">The thickness of the line</param>
        public static void DrawPolygon(this SpriteBatch spriteBatch, Vector2 location, Vector2[] vertices, Color color, float thickness, bool closed = true)
        {
            DrawPoints(spriteBatch, location, vertices.ToList(), color, thickness);

            if (closed == true)
            {
                DrawLine(spriteBatch, vertices[0] + location, vertices[^1] + location, color, thickness);
            }
        }
        ...
        /// <param name="vertices">The array of verts to draw connected lines to</param>
        /// <param name="color">The color to draw the polygon in</param>
        public static void DrawPolygon(this SpriteBatch spriteBatch, Vector2 location, Vector2[] vertices, Color color, bool closed = true)
        {
            DrawPolygon(spriteBatch, location, vertices, color, 1.0f, closed);
        }
        ...
        /// <param name="location">Where to draw</param>
        /// <param name="vertices">The array of verts to draw connected lines to</param>
        public static void DrawPolygon(this SpriteBatch spriteBatch, Vector2 location, Vector2[] vertices, bool closed = true)
        {
            DrawPolygon(spriteBatch, location, vertices, Color.White, 1.0f, closed);
        }
    }
}